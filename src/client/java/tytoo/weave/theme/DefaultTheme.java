...
public class DefaultTheme implements Theme {
    ...
    private void populateDefaultStyles() {
        ...
        stylesheet.addRule(new StyleRule(s, Map.ofEntries(
                Map.entry(ComponentStyle.Slots.BASE_RENDERER, new StyledColorRenderer(Separator.StyleProps.COLOR, new Color(128, 128, 128))),
        ...
        stylesheet.addRule(new StyleRule(s, Map.ofEntries(
                Map.entry(ComponentStyle.Slots.BASE_RENDERER, new ParentStyledColorRenderer(Separator.StyleProps.COLOR, new Color(128, 128, 128))),
                Map.entry(Separator.StyleProps.COLOR, new Color(128, 128, 128))
        )));
        ...
        stylesheet.addRule(new StyleRule(s, Map.ofEntries(
                ...
                Map.entry(ComponentStyle.Slots.BASE_RENDERER, new StyledCircleRenderer(CommonStyleProperties.ACCENT_COLOR, new Color(40, 160, 220)))
        )));
        ...
        stylesheet.addRule(new StyleRule(s, Map.ofEntries(
                Map.entry(ComponentStyle.Slots.BASE_RENDERER, new StyledColorRenderer(PopupStyleProperties.BACKDROP_COLOR, new Color(0, 0, 0))),
