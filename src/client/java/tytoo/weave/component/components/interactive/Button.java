...
public class Button extends InteractiveComponent<Button> {
    ...
    protected void updateVisualState() {
        ...
        Color normalColor = stylesheet.getProperty(this.getClass(), "color.normal", new Color(80, 80, 80));
        Color hoveredColor = stylesheet.getProperty(this.getClass(), "color.hovered", new Color(100, 100, 100));
        Color focusedColor = stylesheet.getProperty(this.getClass(), "color.focused", new Color(120, 120, 120));
